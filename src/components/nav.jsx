...
import ThemeToggle from './ThemeToggle'; // Kept from both branches
...
  const { isSignedIn, user } = useUser(); // useUser provides isSignedIn and user
...
    { title: t('nav.travelPackages'), path: '/travel-packages' }, // <-- KEPT THIS LINE
  ];
...
                    // Using the blue hover from main/cleaned up version.
                    className="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-4 py-2 rounded-lg transition"
                  >
                    Register
                  </button>
...
                <li>
                  <button
                    onClick={() => openModal('signup')} // Corrected to 'signup'
