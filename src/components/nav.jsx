        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            <NavLink to="/" className="flex items-center space-x-2">
              <img src={Logo} alt="Haryana Roadways Logo" className="w-12 h-8" />
            ...
            <div className="hidden md:flex items-center space-x-6">
              <NavLink
                to="/"
                className="nav-strip relative inline-block text-gray-700 hover:text-blue-600 font-medium dark:text-gray-300 dark:hover:text-blue-400"
              >
                {t("nav.home")}
              </NavLink>
              ...
              >
                <button className="text-gray-700 hover:text-blue-600 font-medium flex items-center dark:text-gray-300 dark:hover:text-blue-400 nav-strip">
                  {t("nav.services")}
                  <ChevronDown
              ...
              <NavLink
                to="/trip"
                className="text-gray-700 hover:text-blue-600 font-medium dark:text-gray-300 dark:hover:text-blue-400 nav-strip"
              >
                {t("nav.trip")}
              </NavLink>
              <NavLink
          ...
          <ul className="space-y-4">
            ...
            <li>
              <NavLink
                to="/helpline"
                onClick={toggleSidebar}
                className="block py-2 hover:text-blue-600 dark:text-gray-200 hover:bg-blue-600"
              >
                {t("nav.helpline")}
              </NavLink>
            </li>
            <li>
              <button
              onClick={() => openModal('register')}
              className="bg-blue-500 hover:bg-blue-600 px-4 py-2.5 rounded-lg text-white font-semibold transition  w-[80%]"
            >
              Register
            </button>
            </li>
