...
import { seventhTranslationURL } from "../constants";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-blue-100 text-gray-800">
      ...
      <div className="pt-24 max-w-7xl mx-auto px-4 grid md:grid-cols-4 gap-8">
        ...
        <div
          className="md:col-span-3 bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-gray-100"
          ref={sectionRef}
        >
          {activeSection === "overview" && (
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {currentTranslation.overviewContent.keyFeatures.map(
                  (feature, index) => (
                    <div
                      key={index}
